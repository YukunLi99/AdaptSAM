...
train.output_dir = './output_lora_voc'
...
scheduler = L(MultiStepParamScheduler)(
        ...
        milestones=[4000, 5000],   # 2500 for batchsize 16, 5000 for batchsize 8
...
dataloader.evaluator = [
    L(AgnosticCOCOEvaluator)(
        dataset_name="agnostic_voc_2007_test_ins",  #agnostic_voc_2007_trainval_ins
        tasks=("segm",),
        output_dir = './output_lora_voc',

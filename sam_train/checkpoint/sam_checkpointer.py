...
class DetectionCheckpointer(Checkpointer):
    ...
    def _load_model(self, checkpoint):
        ...
        # if self.model.image_encoder.__class__.__name__ == 'LoRA_Encoder' and \
        #     not 'image_encoder.lora_vit.pos_embed' in [checkpoint['model'].keys()]:
        #     lis_keys = list(checkpoint['model'].keys())
        #     # 处理模型权重 增加 lora_vit
        #     for k in lis_keys:
        #         if 'image_encoder' in k:
        #             checkpoint['model'][k.replace('image_encoder', 'image_encoder.lora_vit')] = checkpoint['model'].pop(k)

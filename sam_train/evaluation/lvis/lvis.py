...
class LVIS:
    def __init__(self, annotation_path, class_agnostic=True): #, thing_classes = None):
        ...
        if class_agnostic:
            self.dataset = self.to_agnostic(self.dataset)
    ...
    def to_agnostic(self,dataset):
        #############
        dataset["ori_categories"] =  dataset["categories"]
        ##############
        ...
        for ii in range(nums):
            ##########
            dataset["annotations"][ii]["ori_category_id"] = dataset["annotations"][ii]["category_id"]
            ##########
    ...
    def _create_index(self):
        ...
        for cat in self.dataset["ori_categories"]:
            self.ori_cats[cat["id"]] = cat
    ...
    def get_cat_ori_ids(self):
        """Get all category ids.

        Returns:
            ids (int array): integer array of category ids
        """
        return list(self.ori_cats.keys())
    ...
    def load_ori_cats(self, ids):
        ...
        Returns:
            cats (dict array) : loaded category dicts
        """
        return self._load_helper(self.ori_cats, ids)

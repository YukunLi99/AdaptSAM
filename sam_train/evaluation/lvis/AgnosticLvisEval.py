...
class AgnosticLVISEvaluator(DatasetEvaluator):
    """
...
def _evaluate_predictions_on_lvis(
    ...
    metrics = {
        ...
        "bbox": ["AP", "AP50", "AP75", "APs", "APm", "APl", "AR@300", "ARs@300", "ARm@300", "ARl@300"],
        "segm": ["AP", "AP50", "AP75", "APs", "APm", "APl", "AR@300", "ARs@300", "ARm@300", "ARl@300"],
    }[iou_type]
    ...
    from .result import LVISResults
    from .lviseval import LVISEval
    # from lviseval import LVISEval
